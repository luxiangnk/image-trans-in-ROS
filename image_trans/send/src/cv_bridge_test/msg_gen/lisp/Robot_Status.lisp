...
(cl:defmethod cl:initialize-instance :after ((m <Robot_Status>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'Robot_Status)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name cv_bridge_test-msg:<Robot_Status> is deprecated: use cv_bridge_test-msg:Robot_Status instead.")))

(cl:ensure-generic-function 'position_x-val :lambda-list '(m))
(cl:defmethod position_x-val ((m <Robot_Status>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader cv_bridge_test-msg:position_x-val is deprecated.  Use cv_bridge_test-msg:position_x instead.")
  (position_x m))

(cl:ensure-generic-function 'position_y-val :lambda-list '(m))
(cl:defmethod position_y-val ((m <Robot_Status>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader cv_bridge_test-msg:position_y-val is deprecated.  Use cv_bridge_test-msg:position_y instead.")
  (position_y m))

(cl:ensure-generic-function 'position_st-val :lambda-list '(m))
(cl:defmethod position_st-val ((m <Robot_Status>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader cv_bridge_test-msg:position_st-val is deprecated.  Use cv_bridge_test-msg:position_st instead.")
  (position_st m))

(cl:ensure-generic-function 'velocity_l-val :lambda-list '(m))
(cl:defmethod velocity_l-val ((m <Robot_Status>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader cv_bridge_test-msg:velocity_l-val is deprecated.  Use cv_bridge_test-msg:velocity_l instead.")
  (velocity_l m))

(cl:ensure-generic-function 'velocity_r-val :lambda-list '(m))
(cl:defmethod velocity_r-val ((m <Robot_Status>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader cv_bridge_test-msg:velocity_r-val is deprecated.  Use cv_bridge_test-msg:velocity_r instead.")
  (velocity_r m))

(cl:ensure-generic-function 'current_rst1-val :lambda-list '(m))
(cl:defmethod current_rst1-val ((m <Robot_Status>))
...
(cl:defmethod current_rst2-val ((m <Robot_Status>))
...
(cl:defmethod current_rst3-val ((m <Robot_Status>))
...
(cl:defmethod current_rst4-val ((m <Robot_Status>))
...
(cl:defmethod current_lst1-val ((m <Robot_Status>))
...
(cl:defmethod current_lst2-val ((m <Robot_Status>))
...
(cl:defmethod current_lst3-val ((m <Robot_Status>))
...
(cl:defmethod current_lst4-val ((m <Robot_Status>))
...
(cl:defmethod current_lpx-val ((m <Robot_Status>))
...
(cl:defmethod current_lpy-val ((m <Robot_Status>))
...
(cl:defmethod current_lpz-val ((m <Robot_Status>))
...
(cl:defmethod current_rpx-val ((m <Robot_Status>))
...
(cl:defmethod current_rpy-val ((m <Robot_Status>))
...
(cl:defmethod current_rpz-val ((m <Robot_Status>))
...
(cl:defmethod roslisp-msg-protocol:serialize ((msg <Robot_Status>) ostream)
  ...
  (cl:let ((bits (roslisp-utils:encode-double-float-bits (cl:slot-value msg 'position_y))))
    ...
    (cl:write-byte (cl:ldb (cl:byte 8 48) bits) ostream)
    (cl:write-byte (cl:ldb (cl:byte 8 56) bits) ostream))
  (cl:let ((bits (roslisp-utils:encode-double-float-bits (cl:slot-value msg 'position_st))))
    (cl:write-byte (cl:ldb (cl:byte 8 0) bits) ostream)
    (cl:write-byte (cl:ldb (cl:byte 8 8) bits) ostream)
    (cl:write-byte (cl:ldb (cl:byte 8 16) bits) ostream)
    (cl:write-byte (cl:ldb (cl:byte 8 24) bits) ostream)
    ...
    (cl:write-byte (cl:ldb (cl:byte 8 48) bits) ostream)
    (cl:write-byte (cl:ldb (cl:byte 8 56) bits) ostream))
  (cl:let ((bits (roslisp-utils:encode-double-float-bits (cl:slot-value msg 'velocity_l))))
    (cl:write-byte (cl:ldb (cl:byte 8 0) bits) ostream)
    (cl:write-byte (cl:ldb (cl:byte 8 8) bits) ostream)
    (cl:write-byte (cl:ldb (cl:byte 8 16) bits) ostream)
    (cl:write-byte (cl:ldb (cl:byte 8 24) bits) ostream)
...
(cl:defmethod roslisp-msg-protocol:deserialize ((msg <Robot_Status>) istream)
  "Deserializes a message object of type '<Robot_Status>"
    ...
    (cl:let ((bits 0))
      ...
      (cl:setf (cl:ldb (cl:byte 8 48) bits) (cl:read-byte istream))
      (cl:setf (cl:ldb (cl:byte 8 56) bits) (cl:read-byte istream))
    (cl:setf (cl:slot-value msg 'position_st) (roslisp-utils:decode-double-float-bits bits)))
    (cl:let ((bits 0))
      (cl:setf (cl:ldb (cl:byte 8 0) bits) (cl:read-byte istream))
      (cl:setf (cl:ldb (cl:byte 8 8) bits) (cl:read-byte istream))
      (cl:setf (cl:ldb (cl:byte 8 16) bits) (cl:read-byte istream))
      ...
      (cl:setf (cl:ldb (cl:byte 8 48) bits) (cl:read-byte istream))
      (cl:setf (cl:ldb (cl:byte 8 56) bits) (cl:read-byte istream))
    (cl:setf (cl:slot-value msg 'velocity_l) (roslisp-utils:decode-double-float-bits bits)))
    (cl:let ((bits 0))
      (cl:setf (cl:ldb (cl:byte 8 0) bits) (cl:read-byte istream))
      (cl:setf (cl:ldb (cl:byte 8 8) bits) (cl:read-byte istream))
      (cl:setf (cl:ldb (cl:byte 8 16) bits) (cl:read-byte istream))
...
(cl:defmethod roslisp-msg-protocol:md5sum ((type (cl:eql '<Robot_Status>)))
  ...
  "bef20fc5bc7e72451d8bbd05d3bb647d")
(cl:defmethod roslisp-msg-protocol:md5sum ((type (cl:eql 'Robot_Status)))
  "Returns md5sum for a message object of type 'Robot_Status"
  "bef20fc5bc7e72451d8bbd05d3bb647d")
(cl:defmethod roslisp-msg-protocol:message-definition ((type (cl:eql '<Robot_Status>)))
  ...
  (cl:format cl:nil "float64 position_x~%float64 position_y~%float64 position_st~%float64 velocity_l~%float64 velocity_r~%float64 current_rst1~%float64 current_rst2~%float64 current_rst3~%float64 current_rst4~%float64 current_lst1~%float64 current_lst2~%float64 current_lst3~%float64 current_lst4~%float64 current_lpx~%float64 current_lpy~%float64 current_lpz~%float64 current_rpx~%float64 current_rpy~%float64 current_rpz~%~%~%~%"))
(cl:defmethod roslisp-msg-protocol:message-definition ((type (cl:eql 'Robot_Status)))
  "Returns full string definition for message of type 'Robot_Status"
  (cl:format cl:nil "float64 position_x~%float64 position_y~%float64 position_st~%float64 velocity_l~%float64 velocity_r~%float64 current_rst1~%float64 current_rst2~%float64 current_rst3~%float64 current_rst4~%float64 current_lst1~%float64 current_lst2~%float64 current_lst3~%float64 current_lst4~%float64 current_lpx~%float64 current_lpy~%float64 current_lpz~%float64 current_rpx~%float64 current_rpy~%float64 current_rpz~%~%~%~%"))
...
(cl:defmethod roslisp-msg-protocol:ros-message-to-list ((msg <Robot_Status>))
  ...
  (cl:list 'Robot_Status
    ...
    (cl:cons ':position_st (position_st msg))
    (cl:cons ':velocity_l (velocity_l msg))
